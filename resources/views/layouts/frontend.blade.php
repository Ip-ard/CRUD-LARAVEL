	  			...
	  			<div class="container">
			  		<div class="row">
			  			...
			  			<div class="col-lg-6 col-sm-6 col-4 header-top-right no-padding">
			  				<a href="{{config('sekolah.telpon')}}"><span class="lnr lnr-phone-handset"></span> <span class="text">081554959366</span></a>
			  				<a href="{{config('sekolah.email')}}"><span class="lnr lnr-envelope"></span> <span class="text">smkdt@domain.com</span></a>			
			  			</div>
			  		</div>			  					
	  			</div>
			</div>
